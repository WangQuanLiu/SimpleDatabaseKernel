...
#define DEBUG_GRAMMATICAL false
	...
	private:
		...
		bool semantic_analysis_delete_element(vector<GramTokenType>&vec);
		bool semantic_analysis_use_database(vector<GramTokenType>& vec);
		bool semantic_analysis_create(vector<GramTokenType>&vec);
		bool semantic_analysis_update(vector<GramTokenType>&vec);
		...
		unsigned get_column_name_position_in_connect_table( string&columnName, vector<CDIT>&columnInfoInTable);
		...
		wcs where_compare_analysis(dbm::shared_ptr<dbm::Item> itemPtr,GramToken& valuesOne, GramToken& compareSymbol, GramToken &valuesTwo, vector<CDIT>&columnInfoInTable);
		wcs where_compare_analysis_both_column(dbm::shared_ptr<dbm::Item> itemPtr, GramToken& valuesOne, GramToken& compareSymbol, GramToken& valuesTwo, vector<CDIT>&columnInfoInTable);
		wcs where_compare_analysis_column_and_literal_char(dbm::shared_ptr<dbm::Item> itemPtr,GramToken& valuesOne, GramToken& compareSymbol, GramToken& valuesTwo, vector<CDIT>&columnInfoInTable);
